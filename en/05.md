...
"Because its nature is predicting the next word," Lao Wang said. "It doesn't care if a sentence is true, only if it 'sounds true.' If the context says a certain answer should follow, it follows without hesitation — even if the answer is fabricated."
